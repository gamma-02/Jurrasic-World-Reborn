...
public class VelociraptorBlueAnimator extends EntityAnimator<VelociraptorBlueEntity> {
    ...
    protected void performAnimations(AnimatableModel parModel, VelociraptorBlueEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
    }
}