...
public class RaphusrexAnimator extends EntityAnimator<RaphusrexEntity> {
    ...
    protected void performAnimations(AnimatableModel parModel, RaphusrexEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
    }
}
