...
public class CoelurusAnimator extends EntityAnimator<CoelurusEntity> {
    ...
    protected void performAnimations(AnimatableModel parModel, CoelurusEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
    }
}
