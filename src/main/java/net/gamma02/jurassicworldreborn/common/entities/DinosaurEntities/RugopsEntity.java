...
{
    public RugopsEntity(Level world, EntityType type)
    {
        super(world, type);
...
//, RaphusrexEntity.class, TyrannosaurusEntity.class, GiganotosaurusEntity.class, SpinosaurusEntity.class));TODO:AI
    }
