...
public class MetriacanthosaurusAnimator extends EntityAnimator<MetriacanthosaurusEntity> {
    ...
    protected void performAnimations(AnimatableModel parModel, MetriacanthosaurusEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
    }
}
