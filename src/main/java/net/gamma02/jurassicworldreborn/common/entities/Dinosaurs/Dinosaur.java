...
public abstract class Dinosaur implements Comparable<Dinosaur> {
    ...
    public void init() {
        ...
        for (GrowthStage growthStage : GrowthStage.values()) {
            ...
            this.maleTextures.put(growthStage, new ResourceLocation(Jurassicworldreborn.modid, baseTextures + formattedName + "_male_" + growthStageName + ".png"));
            this.femaleTextures.put(growthStage, new ResourceLocation(Jurassicworldreborn.modid, baseTextures + formattedName + "_female_" + growthStageName + ".png"));
            this.eyelidTextures.put(new GrowthStageGenderContainer(growthStage, true), new ResourceLocation(Jurassicworldreborn.modid, baseTextures + formattedName + "_male_" + growthStageName + "_eyelid.png"));
            this.eyelidTextures.put(new GrowthStageGenderContainer(growthStage, false), new ResourceLocation(Jurassicworldreborn.modid, baseTextures + formattedName + "_female_" + growthStageName + "_eyelid.png"));


            List<ResourceLocation> overlaysForGrowthStage = new ArrayList<>();

            for (int i = 1; i <= this.getOverlayCount(); i++) {
                overlaysForGrowthStage.add(new ResourceLocation(Jurassicworldreborn.modid, baseTextures + formattedName + "_overlay_" + growthStageName + "_" + i + ".png"));
            }
