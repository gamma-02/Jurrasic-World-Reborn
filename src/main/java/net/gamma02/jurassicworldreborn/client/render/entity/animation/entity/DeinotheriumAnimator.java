...
public class DeinotheriumAnimator extends EntityAnimator<DeinotheriumEntity> {
    ...
    protected void performAnimations(AnimatableModel parModel, DeinotheriumEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
    }
}
