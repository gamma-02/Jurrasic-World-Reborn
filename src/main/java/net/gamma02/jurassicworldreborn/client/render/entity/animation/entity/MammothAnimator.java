...
public class MammothAnimator extends EntityAnimator<MammothEntity> {
    ...
    protected void performAnimations(AnimatableModel parModel, MammothEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
    }
}
