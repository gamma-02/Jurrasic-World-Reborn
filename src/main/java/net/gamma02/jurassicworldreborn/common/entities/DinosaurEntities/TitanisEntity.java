...
public class TitanisEntity extends DinosaurEntity {
    private static final EntityDataAccessor<Integer> VARIANT = EntityDataManager.createKey(TitanisEntity.class, DataSerializers.VARINT);
    ...
    public TitanisEntity(Level world) {
        super(world);
