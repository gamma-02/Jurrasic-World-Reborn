...
public class SmilodonAnimator extends EntityAnimator<SmilodonEntity> {
    ...
    protected void performAnimations(AnimatableModel parModel, SmilodonEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
    }
}
