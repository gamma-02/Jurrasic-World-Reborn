...
public class TroodonDinosaur extends Dinosaur
{
    ...
    public TroodonDinosaur()
    {
        ...
        Stream<TagKey<Biome>> tags = Arrays.stream(new TagKey[]{BiomeTags.IS_SAVANNA, BiomeTags.IS_JUNGLE, Tags.Biomes.IS_CONIFEROUS, Tags.Biomes.IS_PLAINS, BiomeTags.IS_FOREST});
