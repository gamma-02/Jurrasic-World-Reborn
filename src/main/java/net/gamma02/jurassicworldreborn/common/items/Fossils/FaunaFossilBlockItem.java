...
public class FaunaFossilBlockItem extends BlockItem {


    public FaunaFossilBlockItem(Block block, Properties properties) {
    ...
    public Component getName(ItemStack pStack) {
        ...
        return Component.literal(Component.translatable("tile.fossil_block.name").getString().replace("{dinosaur}", LangUtil.getDinoName(dinosaur).getString()) );
    }
