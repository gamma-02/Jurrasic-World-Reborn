...
import net.gamma02.jurassicworldreborn.common.entities.DinosaurEntities.AlligatorGarEntity;
...
protected void performAnimations(AnimatableModel model, AlligatorGarEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
    ...
    //TODO: needs some work. | good greif. Mind elaborating?
        ...
        AdvancedModelBox[] body = new AdvancedModelBox[] { tail5, tail4, tail3, tail2, tail1, body3, body2, body1 };
