...
public class HerrerasaurusAnimator extends EntityAnimator<HerrerasaurusEntity> {
    ...
    protected void performAnimations(AnimatableModel parModel, HerrerasaurusEntity entity, float limbSwing, float limbSwingAmount, float ticks, float rotationYaw, float rotationPitch, float scale) {
    }
}
